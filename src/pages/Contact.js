            ...
            <div className="contact-info-section">
              ...
              <div className="social-links">
                ...
                <div className="social-icons">
                  <button className="social-link" aria-label="Instagram" onClick={() => window.open('https://www.instagram.com/fillesume/', '_blank')}>
                  ...
                  <button className="social-link" aria-label="LinkedIn" onClick={() => window.open('https://www.linkedin.com/company/fille-sume/', '_blank')}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
