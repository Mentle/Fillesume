...
function Model({ mouse, scale, isDragging }) {
  const { scene } = useGLTF(process.env.NODE_ENV === 'production' ? './2fillesume_3dlogo.glb' : `${process.env.PUBLIC_URL}/2fillesume_3dlogo.glb`);
...
// Preload the model
useGLTF.preload('./2fillesume_3dlogo.glb');
